...
export default function Properties({ fixture, onApply, onDelete }: { fixture: Fixture; onApply: (changes: Changes) => void; onDelete: () => void }) {
  ...
  return <form className="property-form" onSubmit={apply}>
    <p className="fixture-reference" title={fixture.id}>{fixture.id}</p>
